...
\title[Analysis]{Notes on Analysis}
...
% \etocstandarddisplaystyle (etoc) is deprecated.  Please use \etocclasstocstyle.
...
\input{chapters/measures.tex}
\input{chapters/integration.tex}
\input{chapters/signed_measures.tex}
